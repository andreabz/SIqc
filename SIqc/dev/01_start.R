...
##
golem::fill_desc(
  pkg_name = "SIqc", # The Name of the package containing the App
  pkg_title = "SIqc", # The Title of the package containing the App
  pkg_description = "A shiny app for the laboratory quality control data management.",
  ...
  repo_url = "https://github.com/andreabz/SIqc.git", # The URL of the GitHub Repo (optional),
...
usethis::use_code_of_conduct(contact = "Andrea Bazzano")
